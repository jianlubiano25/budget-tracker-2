...
function render(){
  ...
  const app=D('');app.style.cssText='margin:0 auto;height:100vh;height:100dvh;background:#f7f3ee;display:flex;flex-direction:column;overflow:hidden';app.className='ipon-app';
